...
parser.add_argument("--district", choices=["lm", "um", "both"], default="both",
                    help="Restrict this run to lower (lm), upper (um), or both Mississippi surveys")
...
new_ids_lm = lm_ids_df['ID'].tolist() if args.district in ("lm", "both") else []
new_ids_um = um_ids_df['ID'].tolist() if args.district in ("um", "both") else []
